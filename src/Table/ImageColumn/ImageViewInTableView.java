...
public class ImageViewInTableView extends Application {
	...
	public Parent createContent() {
		...
		CustomImage item_1 = new CustomImage(new ImageView(new Image("file:resources/img/item.png")));
		CustomImage item_2 = new CustomImage(new ImageView(new Image("file:resources/img/tool.png")));
